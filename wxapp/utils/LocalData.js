const LocalData = {
  ...
  baseInfo: { //基础信息
    enName: 'WangYuan', //英文名
    title: 'web',  //职位英文名
    nameAndSex: '王园 / 男', //中文名/性别
    birthday: '1992/01/08', //生日
    diplomaAndSchool: '本科 / 信息与计算科学', //学历/学校
    workAge: '2年', //工作年限
    location: '杭州',  //工作地点
    wantPosition: '前端工程师', //期望职位
    salary: '12K ~ 15K', //期望薪酬
    mobilePhone: '18668038687',//移动手机
    email: '18668038687@163.com',//邮箱
    wechatNo: '18668038687',//微信号
    github: 'wangyuan0108', //github 用户名
    githubUrl: 'https://github.com/wangyuan0108', //github主页
  },
  skillList: [  //技能清单
    'Web开发：Node.js',
    'Web框架：Koa / Express',
    'CSS框架：Bootstrap / ElementUI / Sass ',
    'JS框架：Jquery / React / Vue',
    '构建工具：Webpack / Gulp / NPM',
    '数据库相关：MySQL / Mongodb',
    '版本管理：Svn / Git',
    '微信：公众号开发 / 小程序开发',
    '图表工具： EChars'
